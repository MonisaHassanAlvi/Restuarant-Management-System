<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deliveryinfo.aspx.cs" Inherits="project.deliveryinfo" %>
...
<form  runat="server" class="formoid-biz-gold" style="background-color:#1A2223;font-size:14px;font-family:'Open Sans',Arial,Verdana,sans-serif;color:#ECECEC;max-width:500px;min-width:300px" method="post" id="form"><div class="title"><h2>delivery</h2></div>
	...
	<div class="element-input" title="Delivery Address">
        ...
        <input id="address" runat="server" class="large" type="text" name="input" placeholder="Delivery Address"  required="required"/>
    ...
    <div class="submit">
        ...
        <asp:Button ID="Button1" runat="server" Text="Add"  OnClick="Click" BackColor="#E99D46" Font-Bold="True" ForeColor="Black"/>
