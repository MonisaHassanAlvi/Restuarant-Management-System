<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dishes.aspx.cs" Inherits="project.dishes" %>
...
<form  runat="server" class="formoid-biz-gold" style="background-color:#1A2223;font-size:14px;font-family:'Open Sans',Arial,Verdana,sans-serif;color:#ECECEC;max-width:500px;min-width:300px" method="post" id="form">
    <div class="title" style="border: solid 1px #E99D46">
        ...
        <asp:Button ID="Button4" runat="server" Text="CART"  OnClick="Button1_Cart" ForeColor="Black" Font-Bold="True" Font-Size="Small" Height="41px" Width="95px" BackColor="#E99D46"/>
        </h1></div>
	...
	<div class="element-multiple">
        <label class="title">
         ...
         <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList5"  runat="server" Width="123px" >
        ...
        <br>
        <div>
            <asp:Button ID="Button1" runat="server" Text="+" OnClick="Click" ForeColor="Black" Font-Bold="True" BackColor="#E99D46"  />
        </div>
    ...
    <div class="submit">
        <asp:Button ID="Button3" runat="server" Text="Skip"  OnClick="Button1_Click" ForeColor="Black" Font-Bold="True" BackColor="#E99D46"/>
        <asp:Button ID="Button2" runat="server" Text="Next"  OnClick="Button1_Click" ForeColor="Black" Font-Bold="True" BackColor="#E99D46"/>
    </div>
